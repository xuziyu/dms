 ...
 * <li> 403，参数值错误，即前端传递的参数值超出数据库获取参数值范围。
 * </ul>
...
public class ResponseUtil {
    ...
    public static Object okList(List list) {
        ...
        data.put("list", list);
        data=getData(list,data);
        return ok(data);
    }
    public static Map<String, Object> getData(List list,Map<String, Object> data ){
    ...
    public static Object okMap(List list1,List list2,Object total) {
        Map<String, Object> data = new HashMap<String, Object>();
        data.put("list", list1);

        if (list1 instanceof Page) {
            Page page = (Page) list1;
            data.put("total", page.getTotal());
            data.put("page", page.getPageNum());
            data.put("limit", page.getPageSize());
            data.put("pages", page.getPages());
            data.put("orderStatus",list2);
        }
        else{
            data.put("page", 1);
            data.put("limit", list1.size());
            data.put("pages", 1);
            data.put("orderStatus",list2);
    ...
    public static Object okListPage(List list, List pagedList) {
        Map<String, Object> data = new HashMap<String, Object>();
        data.put("list", list);
        data=getData(pagedList,data);
        return ok(data);
    }
